...
describe("Sign up", () => {
	...
	it("Should return true on a 200 response", async () => {
		vi.spyOn(AuthClient.prototype, "signUp").mockImplementation(
			async () => ({
				code: 200,
				name: "ok",
				data: { username: "Foo" },
...
describe("Sign in", () => {
	...
	it("Should return true on a 200 response", async () => {
		vi.spyOn(AuthClient.prototype, "signIn").mockImplementation(
			async () => ({
				code: 200,
				name: "ok",
				data: { username: "Foo" },
...
describe("Validate", () => {
	...
	it("Should return true on a 200 response", async () => {
		vi.spyOn(AuthClient.prototype, "validate").mockImplementation(
			async () => ({
				code: 200,
				name: "ok",
				data: { username: "Foo" },
